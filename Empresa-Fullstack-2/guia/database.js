...
// Nuestra lista inicial de productos (la tomé de tu archivo detalle.html)
const initialProducts = [
    { id:"JM001", nombre:"Catan", categoria:"Juegos de Mesa", precio: 29990, vendidos:42, imagen:"img/catan.jpg", descripcion:"Un juego de estrategia donde los jugadores colonizan una isla construyendo pueblos y rutas." },
...
// Llama a la inicialización al cargar el script
initializeDB();
...
/**
 * CREATE: Agrega un nuevo producto a la base de datos.
 * @param {Object} newProduct - El nuevo producto a agregar.
 */
export function createProduct(newProduct) {
    // Generamos un ID simple basado en la fecha para este ejemplo
    if (!newProduct.id) {
 ...
 * @param {Object} updatedData - Los datos actualizados del producto.
 */
